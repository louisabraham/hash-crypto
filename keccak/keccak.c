...
void FIPS202_SHAKE128_ITER(u64 iter, const u8 *in, u64 inLen, u8 *out, u64 outLen) { if(!iter) return; FIPS202_SHAKE128(in, inLen, out, outLen); for(u64 i=0;i<iter-1;++i) FIPS202_SHAKE128(out, outLen, out, outLen); }
